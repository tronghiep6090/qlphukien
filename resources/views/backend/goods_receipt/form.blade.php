    ...
    <div class="box-body">
        <div class="form-group {{ $errors->has('w_code') ? 'has-error' : '' }}">
            ...
            <div class="col-sm-12" style="display: inline-block; padding: 0px;">
                <input class="form-control random_code" id="random_code" oninput="if(value.length>15)value=value.slice(0,15)" name="w_code" value="{{ old('w_code', isset($warehousing) ? $warehousing->w_code : '') }}" type="text" placeholder="Mã đơn hàng (DHX_)" required>
            </div>
