...
class ProductWarehousing extends Model
{
    ...
    protected $fillable = [
        'pw_product_id', 'pw_warehousing_id', 'pw_supplier_id', 'pw_customer_id', 'pw_total_number', 'pw_manufacturing_date', 'pw_expiry_date', 'pw_active_price', 'pw_custom_price', 'pw_total_price', 'pw_note', 'created_at', 'updated_at',
    ];
